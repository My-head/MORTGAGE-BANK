...
public class SAWLController {
    ...
    void analisys() {
        ...
        double demoW1=(((double)analisysInfo.getZ111()+(double)analisysInfo.getZ121()+(double)analisysInfo.getZ131())/3);
        double demoW2=(((double)analisysInfo.getZ211()+(double)analisysInfo.getZ221()+(double)analisysInfo.getZ231())/3);
        double demoW3=(((double)analisysInfo.getZ311()+(double)analisysInfo.getZ321()+(double)analisysInfo.getZ331())/3);
        ...
        double demoE1=(((double)analisysInfo.getZ112()+(double)analisysInfo.getZ122()+(double)analisysInfo.getZ132())/3);
        double demoE2=(((double)analisysInfo.getZ212()+(double)analisysInfo.getZ222()+(double)analisysInfo.getZ232())/3);
        double demoE3=(((double)analisysInfo.getZ312()+(double)analisysInfo.getZ322()+(double)analisysInfo.getZ332())/3);
        ...
        double demoW= (((double)analisysInfo.getZ311()+(double)analisysInfo.getZ321()+(double)analisysInfo.getZ331())/3);
        W.setText(Double.toString(demoW));
        analisysInfo.setW(demoW);

        double demoE= (((double)analisysInfo.getZ312()+(double)analisysInfo.getZ322()+(double)analisysInfo.getZ332())/3);
